    ...
    <section className="py-20 bg-[#050d0a] relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="section-title mb-6">The Minds Behind <span className="text-[#22c55e]">Savar Science Society</span></h2>
        </div>


        {/* Row 1: Advisor & Founder */}
        <div className="flex justify-center">
          <div className="badge mb-10">Our Advisors</div>
        </div>
        ...
        <div className="flex justify-center">
          <div className="badge mb-10">Our Leaders</div>
        </div>
...
function LeaderCard({ member, index, isLarge = false }: { member: any; index: number; isLarge?: boolean }) {
  return (
    <motion.div
      ...
      className={`group ${isLarge ? "w-full max-w-[400px]" : "w-full sm:w-[320px]"}`}
    >
